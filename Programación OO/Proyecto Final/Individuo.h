...
class Individuo
{
  ...
  */
  ...
  // Sobrecarga para identificadores personalizados.
  Individuo(string nombre, char identificador, bool manejaLaBarca, bool esVigilante);
  /**
  ...
  */
  char identificadorPersonaje();
  /**
  esVigilante: En caso de ser un vigilante, reot.
  */
