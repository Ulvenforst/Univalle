...
class Jugador
{
  ...
  */
  virtual void jugar();
  /**
  moverPersonaje: Se encarga de mover un personaje de un lugar a otro, retorna un bool que 
  indica el éxito del proceso.
  */
  virtual bool moverPersonaje(string identificador);
  /**
  moverBarca: Se encarga de mover la barca de lugar, retorna un bool que indica el éxito del proceso.
  */
  virtual bool moverBarca();
  /**
